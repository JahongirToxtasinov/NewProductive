...
import 'package:new_productive/features/home/presentation/widgets/nav_bar_item.dart';

import '../../../constants/colors.dart';
import '../../../constants/icons.dart';

import '../data/models/navbar.dart';
import '../data/navigator.dart';
...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    labels = const [
      NavBar(id: 0, icon: GlobalIcons.tasks, title: "Tasks"),
      NavBar(id: 1, icon: GlobalIcons.expense, title: "Expense"),
      NavBar(id: 2, icon: GlobalIcons.create, title: "Create"),
      NavBar(id: 3, icon: GlobalIcons.calendar, title: "Calendar"),
      NavBar(id: 4, icon: GlobalIcons.stats, title: "Stats"),
    ];
